...
public class RQC2PaymentsMonthlyRefinance extends QCStore{
	...
	public static void StepUp(String SSN,String AppURL) throws Exception{
		...
		{		
			...
			{		
				...
				Thread.sleep(10000);	
				driver.findElement(By.name("requestBean.siilBean.paymentAmt")).sendKeys(Keys.chord(Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE)+PaymentAmount);
				test.log(LogStatus.PASS, "<FONT color=green style=Arial>Payment Amount Entered : "+PaymentAmount );				
				Thread.sleep(10000);
				driver.findElement(By.name("qualify")).click();
				test.log(LogStatus.PASS, "Clicked on qualify button ");
				Thread.sleep(20000);
				driver.findElement(By.name("requestBean.siilBean.tenderAmtFirst")).sendKeys(Keys.chord(Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE)+PaymentAmount);
				               //test.log(LogStatus.PASS, "<FONT color=green style=Arial>Payment Amount Entered : "+PaymentAmount );	
				Thread.sleep(500);
				driver.findElement(By.name("qualify")).click();
				Thread.sleep(20000);
...
*/
					...
					test.log(LogStatus.PASS, "click on Customer Agreement PopUp Yes button ");
					Thread.sleep(8000);
		...
		{		
			...
			{		
			   ...
			   /* if (Actual_DisbAmount.trim().equalsIgnoreCase(DisbAmount.trim())) {
				...
				test.log(LogStatus.PASS, "<FONT color=green style=Arial>Getting Due amount : "+AmountDue );
				Thread.sleep(500);
				String RefinanceEligibleAmount=driver.findElement(By.name("requestBean.payOffAmt")).getAttribute("value");				
				test.log(LogStatus.PASS, "<FONT color=green style=Arial>Getting Refinance Eligible Amount : "+RefinanceEligibleAmount );
				Thread.sleep(500);
				String stepsamemsg=driver.findElement(By.xpath("//*[@id='_StepUpDown']")).getText();
				
				test.log(LogStatus.PASS, "<FONT color=green style=Arial>getting  message  : "+stepsamemsg );
				Thread.sleep(5000);

				if(stepsamemsg.contains("Step Same")){
