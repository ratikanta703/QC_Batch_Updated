...
public class RQCSemiMonthlyRefinance extends QCStore{
	...
	public static void StepUp(String SSN,String AppURL) throws Exception{
		...
		{		
			...
			{		
				...
				Thread.sleep(3000);
				test.log(LogStatus.INFO,"**************Refinance StepUp  started**************");
				Thread.sleep(3000);
				...
				if(stepupmsg.contains("Stepped Up by Amount")){
					...
					if(ESign_CollateralType.equalsIgnoreCase("ACH")){
						...
						test.log(LogStatus.PASS, "<FONT color=green style=Arial>Loan Fee Amount is"+LoanFee );
						Thread.sleep(500);
		...
		{		
			...
			{		
				...
				if (LoanAmount.equals(RefinanceLoanAmount)){
					...
					test.log(LogStatus.FAIL, "Refinance Loan->Refinance Loan Amount Expected value:"+LoanAmount +"; not equals to Actual value:"+RefinanceLoanAmount);
				}	
               ...
               /* Thread.sleep(500);
				...
				//String RollOverAmount=driver.findElement(By.name("htmlLoanAmt")).getAttribute("value");
				if (ProvidedRefinanceType.equals(stepupmsg)){
						
					test.log(LogStatus.PASS, "<FONT color=green style=Arial>Refinance Message->Expected value:"+ProvidedRefinanceType +"; == Actual value:"+stepupmsg );
				}
				else{
					test.log(LogStatus.FAIL, "Refinance Message->Expected value:"+ProvidedRefinanceType +"; not equals to Actual value:"+stepupmsg);
				}	*/
